...
public class GameManager implements KeyListener, Init, Tick , Render {
...
@Override
    public void init(){
        ...
        player = new Player((Engine.gameWidth/2)+50,(Engine.gameHeight-60)+50);
        player.init();
...
@Override
    ...
    public void render(Graphics g){
        if(start){player.render(g);
            ...
            g.drawString("Press enter to start", 100, (Engine.gameHeight/2)+50);
